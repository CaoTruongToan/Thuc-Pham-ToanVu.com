    ...
    <div class="container">
        <ul class="breadcrumb">
            ...
            foreach ($danhmucs as $danhmuc) {
                if ($sp['id_danhmuc'] == $danhmuc['id']) {
                    echo '
                        <li>
                            <a class="changeurl nav-link" href="index.php?act=sanpham&id_danhmuc=' . $danhmuc['id'] . '">' . $danhmuc['tendanhmuc'] . '</a>
                        </li>
                    ';
                }
            }
                        ...
                        <div class="row mt-10">
                               ...
                               if ($sanphamkhuyenmai == 1) {
                                ...
                                echo '
                                    <div class="col-3 text-center">
                                        <span id="gia_sanpham">' . $giamoi_formatted . '</span> đ
                                    </div>
                                ';
                                } else {
                            ...
                            <div class="col-3 text-center">
                                <div class="soluong">
                                    ...
                                    <input type="text" min="1" max="10000" name="soluong" value="0" step="1" class="check_sl" oninput="handleInput(this)" onkeypress="return isNumberKey(event)">
