...
<head>
    ...
    <link rel="stylesheet" href="view/assests/styles.css">
    <link rel="stylesheet" href="view/assests/bootstrap/css/bootstrap.min.css">
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-3 col-6 py-1">
                        <a href="index.php">
                            <img src="view/assests/img/GreenLogo.png" alt="logo" class="logo-img img-fluid">
                        </a>
                    </div>

                    <!-- Search Form -->
                    <div class="col-md-5 col-6 pt-4">
                    ...
                    <div class="col-md-4">
                        <div class="row mt-4 pt-2 ps-3">
                            ...
                            <div class="col-md-4 col-4">
                                <a href="index.php?act=addtocart" class="position-relative text-decoration-none">
                                ...
                                <a href="index.php?act=addtocart" class="fs-6 ms-3 text-decoration-none text-dark">Giỏ hàng</a>
                            </div>
                                ...
                                <div class="dropdown">
                                    <?php if (isset($_SESSION["user"])) : ?>
                                        <a type="button" class="position-relative text-decoration-none" data-bs-toggle="dropdown" aria-expanded="false">
                                            ...
                                            $display_name = $user; // Thay $user bằng tên biến chứa thông tin tên đăng nhập của người dùng
                                            ?>
                    ...
                    <div class="col">
                        <nav class="navbar navbar-expand-lg">
                            <div class="container-fluid">
                                ...
                                <button class="navbar-toggler" style="font-size: 12px;" type="button" data-bs-toggle="collapse"
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                        ...
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle text-white me-4 fw-bold" href="#" role="button"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active text-white me-4 fw-bold" aria-current="page" href="index.php?act=giaohang">Giao Hàng</a>
                                        </li>
                                        <li class="nav-item">
